...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{2Co 5.14-17 (ARA)}
        \QUOTE{%
            ...
            \ver{16}~Assim que, nós, daqui por diante,
            a ninguém conhecemos segundo a carne;
            e, se antes conhecemos Cristo segundo a carne,
            já agora \alt<2>{\YEL{não o conhecemos deste modo}}{não o conhecemos deste modo}.
            \ver{17}~E, assim,
            se alguém \alt<3>{\YEL{está em Cristo}}{está em Cristo},
            é nova criatura;
            as coisas antigas já passaram;
            eis que se fizeram novas.
        }
