...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Introdução -- Divisão do Tema}
        \begin{columns}
            ...
            \uncover<1->{
                Vida Abundante \YEL{\emph{em} Cristo}:\\[\medskipamount]
            }
            \begin{itemize}
                \item<1-> \BRI{Parte 1} -- Base de verdade:\\
                    \uncover<2->{Nossa \YEL{posição} em \MAG{Jesus Cristo};}
            ...
            \begin{enumerate}
                \item<6->  mortos para o pecado e vivos para Ti \YEL{em Cristo};
                \item<7->  ...
                \item<8->  ...
                \item<9->  ...
                \item<10-> ...
