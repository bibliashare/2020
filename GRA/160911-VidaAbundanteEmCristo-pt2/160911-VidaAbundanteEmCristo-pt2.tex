...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Os 5 Imperativos de Rm 6.11--13 (ARA)}
        \QUOTE{%
            %-----!j 92 -i12
            \ver{11}~Assim também vós \YEL{considerai-vos mortos para o pecado, mas vivos para
            Deus}, \MAG{em Cristo Jesus}.
            %-----!j 92 -i12
            \ver{12}~\RED{Não reine, portanto, o pecado em vosso \emph{corpo} mortal}, de
            maneira que obedeçais às suas paixões;
            %-----!j 92 -i12
            \ver{13}~\ORA{nem ofereçais cada um os \emph{membros} do seu corpo ao pecado}, como
            \BRI{instrumentos} de iniquidade; mas \GRE{oferecei-\emph{vos} a Deus, como
            ressurretos dentre os mortos}, e \CYA{os vossos \emph{membros}, a Deus}, como
            \BRI{instrumentos} de justiça.
        }
    \end{frame}
