...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Despojar-se do velho homem: Rm 6.11--13a (ARA)}
        \QUOTE{
            Oração:\\
            Pai, te \BRI{agradeço por estar} morto para o pecado / e vivo para
            Ti, \MAG{em Cristo Jesus}. \\
            Eu \BRI{escolho não mais viver pelo meu ponto de vista}. \\
            Eu \BRI{escolho não entregar qualquer membro do meu corpo ao meu
            ponto de vista}.
        }
    \end{frame}
