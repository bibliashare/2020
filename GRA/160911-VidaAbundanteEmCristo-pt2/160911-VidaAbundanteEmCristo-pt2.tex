...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Despojar-se do velho homem: Rm 6.11--13a (ARA)}
        \QUOTE{\normalsize
            Oração:
            \\[\bigskipamount]
            Pai, eu \YEL{creio} que estou morto para o pecado e vivo para ti, em Cristo Jesus.
            \\[\medskipamount]
            Eu \YEL{escolho} não mais viver pelo meu ponto de vista.
            \\[\medskipamount]
            Eu \YEL{escolho} não entregar qualquer membro do meu corpo ao meu ponto de vista.
        }
    \end{frame}
