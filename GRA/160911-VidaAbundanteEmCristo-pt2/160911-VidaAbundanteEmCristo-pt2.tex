...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Os \YEL{Cinco Imperativos} de Rm 6.11--13 (ARA)}
        \QUOTE{%
            %-----!j 92 -i12
            \ver{11}~Assim também vós
            \alt<2->{\YEL{considerai-vos mortos para o pecado, mas vivos para
            Deus}}{considerai-vos mortos para o pecado, mas vivos para Deus},
            \alt<2->{\MAG{em Cristo Jesus}}{em Cristo Jesus}.
            %-----!j 92 -i12
            \ver{12}~%
            ...
            \alt<6->{\CYA{os vossos \underline{\emph{membros}}, a Deus}}{os vossos membros, a
