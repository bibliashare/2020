...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Gn 9 (TB)}
        \QUOTE{%
            ...
            \YEL{da mão de todo o animal, o requererei}; e, \YEL{da mão do homem}, sim, da mão
    ...
    \begin{frame}{Gn 9 (TB)}
        \QUOTE{%
            %-----!j 92 -i12
            \ver{12}~Disse Deus: Este é o sinal da aliança que faço entre mim e vós e todo o
            animal vivente que está convosco, para perpétuas gerações:
            %-----!j 92 -i12
