...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{\BRI{Gn 17} (TB)}
        \QUOTE{%
            %-----!j 92 -i12
            \ver{1}~Quando Abrão era de noventa e nove anos de idade, apareceu-lhe Jeová e
            disse: Eu sou Deus Todo-Poderoso; anda diante de mim e sê perfeito.
            %-----!j 92 -i12
            \ver{2}~Eu farei uma aliança entre mim e ti e te multiplicarei grandissimamente.
            %-----!j 92 -i12
    ...
    \begin{frame}{\BRI{Gn 17} (TB)}
        \QUOTE{%
            %-----!j 92 -i12
            \ver{4}~Quanto a mim, a minha aliança é contigo, e serás pai de uma multidão de
            nações.
            %-----!j 92 -i12
            \ver{5}~O teu nome não se chamará mais Abrão, mas Abraão será o teu nome; pois te
            hei posto por pai de uma multidão de nações.
            %-----!j 92 -i12
            \ver{6}~Far-te-ei frutificar grandissimamente e de ti farei nações, e de ti sairão
            reis.
        }
    \end{frame}
    ...
    \begin{frame}{\BRI{Gn 17} (TB)}
        \QUOTE{%
            %-----!j 92 -i12
            \ver{7}~Estabelecerei a minha aliança entre mim e ti e a tua semente depois de ti,
            nas suas gerações, por uma aliança eterna, e para que eu seja o teu Deus e o da tua
            semente depois de ti.
            %-----!j 92 -i12
            \ver{8}~Dar-te-ei a ti e à tua semente depois de ti a terra das tuas peregrinações,
    ...
    \begin{frame}{\BRI{Gn 17} (TB)}
        \QUOTE{%
            %-----!j 92 -i12
            \ver{9}~Disse mais Deus a Abraão: Quanto a ti, guardarás a minha aliança, tu e a tua
            semente depois de ti, nas suas gerações.
            %-----!j 92 -i12
            \ver{10}~Esta é a aliança que guardareis entre mim e vós e a tua semente depois de
            ti: todo o macho dentre vós será circuncidado.
        }
    \end{frame}
