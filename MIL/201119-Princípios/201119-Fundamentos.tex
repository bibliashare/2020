...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}
        ...
        \begin{minipage}{0.9\linewidth}%
            \large%
            \begin{alertblock}{Sumário --- O Primeiro Adão}
                \normalsize
                \begin{itemize}
                    \item<1-> \YEL{Primeiro} homem \YEL{Adão}, feito à \YEL{imagem de Deus},
                        \YEL{dominando} a \YEL{terra};
                    \item<2-> Inicialmente \YEL{sozinho}, no \YEL{jardim};
                    \item<3-> Depois coletivamente (\YEL{corpo}), por \YEL{toda a terra};
                    \item<4-> \YEL{Deus} propunha, o \YEL{homem} fazia, e o fazia com
                        \YEL{liberdade}.
                    \item<5-> O \CYA{último Adão}, Cristo Jesus encarnado, é a \CYA{expressão
                        exata de Deus}\footnote{Cl 1.15; Hb 1.3; Jo 14.9,10};
                    \item<6-> Inicialmente \CYA{sozinho}, grão de \CYA{trigo}, caído na terra;
                    \item<7-> Depois coletivamente (\CYA{corpo}), no erguer da cruz, \CYA{atraiu
                        a todos};
                    \item<8-> Mesmo podendo, \CYA{não age de si mesmo}\footnote{Jo 5.30,31;
                        8.28}, e dá \CYA{vida abundante}.
                \end{itemize}
            \end{alertblock}
        \end{minipage}%
    \end{frame}
