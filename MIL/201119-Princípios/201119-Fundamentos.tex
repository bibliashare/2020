            ...
            \begin{alertblock}{Sumário --- O Primeiro Adão}
                ...
                \begin{itemize}
                    ...
                    \item<2-> O \CYA{último Adão}, Cristo Jesus encarnado, é a \CYA{expressão
                        exata de Deus}\footnote{Conf.~Hb 1.3; ``\GRE{imagem do Deus invisível}''
                        -- Cl 1.15; ``\GRE{eu e o Pai somos um}'' -- Jo 10.30};
                    ...
                    \item<2-> Depois coletivamente (\CYA{corpo}), no erguer da cruz, \CYA{atraiu
                        a todos};
                    \item<2-> Mesmo podendo, \CYA{não age de si mesmo}\footnote{Conf.~Jo
                        5.30,31; ``\GRE{nada faço por mim mesmo; mas como o Pai me ensinou}'' --
