...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{João 1.1,14,18 -- Aplicações}
        \begin{itemize}
            ...
            \item<2-> $\rightharpoondown\qquad$ O homem \MAG{Cristo Jesus}!
            \item<3-> Jesus Cristo \YEL{é Deus}! \uncover<4->{Ele é o meu Deus!}
            \item<5-> Jesus Cristo \YEL{é} o \MAG{Deus Filho}, que veio a ser \RED{homem}.
            \item<6-> O apóstolo que testemunha viu sua \YEL{glória}, \YEL{graça} e
                \YEL{verdade}! \\[\bigskipamount]
            \item<7-> Assim, o reconciliador entre \BLU{Deus} e \RED{homens} é um \MAG{homem}!
            \item<8-> E também é \BLU{Deus}!
        \end{itemize}
    \end{frame}
