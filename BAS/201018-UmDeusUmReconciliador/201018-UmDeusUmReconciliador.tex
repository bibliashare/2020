...
%-----------------------------------------------------------------------------------------------
\newcommand{\dupl}[1]{\makebox[0.7pt][l]{{#1}}{#1}}
%-----------------------------------------------------------------------------------------------
\newcommand{\ver}[1]{%
    \raisebox{0.50ex}{%
        \scalebox{1.1}{%
...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{João 1.1,14,18}{Tradução própria}
        \QUOTE{%
            %-----!j 48 -i12
            \small
            \ver{1}~No princípio existia  \MAG{a
            Palavra}, e \MAG{a  Palavra}  estava
            voltada para Deus, e \MAG{a  Palavra
            era Deus}. [...]  \ver{14}~e  \MAG{a
            Palavra veio a ser  carne}  e  armou
            tenda em nosso meio e contemplamos a
            sua \YEL{glória} como  de  unigênito
            do Pai, repleto de \YEL{graça} e  de
            \YEL{verdade}.                 [...]
            \ver{18}~Ninguém jamais \pmb{v}iu a
            Deus: o  \MAG{Deus  unigênito}---que
            permanece estando  no  recôndito  do
            Pai---este {\it o}\footnote{Ou: {\it
            se}} demonstrou.
        }
    \end{frame}
