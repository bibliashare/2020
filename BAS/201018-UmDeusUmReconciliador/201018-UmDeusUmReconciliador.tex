...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{João 1.1,14,18 (Trad.~própria)}
        \QUOTE{%
            ...
            \underline{v}iu\footnote{\textbf{\textsf{PERF}}:  \textit{ação   consumada   $+$
            resultado  permanecente\/}:  `viu  $+$  Deus  ficou  visto.'}  a  \BRI{Deus}:  o
            \MAG{Deus unigênito}---que permanece estando no  recôndito  do  \BRI{Pai}---este
            {\it \BRI{o}} demonstrou.
        }
    \end{frame}
...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{1Tm 2.5,6 (ARC)}
        \QUOTE{%
            %-----!j 92 -i12
            \ver{5}~Porque há um só Deus e um só mediador entre  Deus  e  os  homens,  Jesus
            Cristo, homem, \ver{6}~o qual se deu a si mesmo em preço de redenção por  todos,
