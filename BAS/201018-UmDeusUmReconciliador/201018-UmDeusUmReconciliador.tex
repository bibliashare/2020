...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{1 Timóteo 2.5}{Aplicações}
        \begin{itemize}
            \item<1-4> \alt<1,2>{Deus \YEL{existe}!}{Deus \YEL{existe} e é \YEL{um só}!}
            \item<2,4> \alt<2>{Há \YEL{um só} Deus!}{\uncover<4->{
                    Existe \RED{necessidade de reconciliação} da humanidade com Deus!
                }}
        \end{itemize}
    \end{frame}
